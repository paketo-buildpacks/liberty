...
| `$BP_LIBERTY_SERVER_NAME`      | Name of the server to use. If not set, the buildpack tries to detect the server name for packaged servers. Otherwise, it defaults to `defaultServer`.                                                                                                               |
